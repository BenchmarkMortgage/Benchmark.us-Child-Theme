...
function benchmark_scripts() {
    ...
    wp_enqueue_script('benchmark.wow', get_stylesheet_directory_uri() . '/js/benchmark.wow.js', array('wow'), '1.1', true);
    wp_enqueue_script('wow', get_stylesheet_directory_uri() . '/js/wow.min.js', array('jquery'), '1.1.0', true);
